 ...
 */
@WebServlet("/printTakenServlet")
public class printTakenServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public printTakenServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		out.println("<html><body><br> <h3>Course id of All courses <b>Taken</b> by "+request.getSession().getAttribute("UserId")+"</h3><hr><br>");
